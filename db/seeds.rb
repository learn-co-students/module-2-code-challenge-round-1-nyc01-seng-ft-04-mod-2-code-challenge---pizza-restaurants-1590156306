...
puts "destroying pizza"
Pizza.destroy_all
puts "destroying association"
...
5.times do
  RestaurantPizza.create(price:rand(1..30), restaurant_id:Restaurant.all.sample.id, pizza_id:Pizza.all.sample.id)
end
